...
const Main = () => {
  ...
  return (
    ...
    >
      ...
      <header className="relative z-10 w-[1000px] mr-auto ml-auto text-center mt-[-750px]">
        <motion.p 
      ...
      <motion.section 
        className="text-[#857e71] mr-auto ml-auto w-[900px] text-center mt-20 mb-20"
        initial="offscreen"
      ...
      >
        ...
        <p className="mt-3 w-[700px] mr-auto ml-auto text-lg font-helvetica">
        ...
        <h3 className="text-4xl mt-16">Lorem Ipsum</h3>
        <p className="mt-4 w-[700px] ml-auto mr-auto">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit.
          Ducimus deleniti dicta corrupti eligendi, minima, ipsum eos id assumenda illo
      ...
      >
        ...
        <h1 className="text-center text-6xl mt-32 text-white">
          Recenze
        </h1>
          ...
          {[
            ...
            return (
              <motion.div 
                ...
                viewport={{ once: false, amount: 0.8 }}
              >
                <div className="w-[300px] h-fit bg-white mr-10 ml-10 mt-10 mb-10">
