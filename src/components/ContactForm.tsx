		...
		<section className="">
			<div className="grid grid-cols-2 w-[1100px] ml-auto mr-auto">
				...
				<div className="float-right text-right">
					<button
						onClick={backToTop}
						className="bg-[#857E71] opacity-70 text-white p-2"
					>
						<svg
			...
			<h1 className="text-[#857E71] text-center text-4xl mt-10">
				Kontaktujte mě
			</h1>
			...
			<form
				onSubmit={openMail}
				action="/"
				className="mt-3 mb-20 w-[500px] mr-auto ml-auto text-center outline-none"
			>
				<input
					type="text"
					name="name"
